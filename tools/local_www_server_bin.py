...
# --- THE FIX ---
# We create a subclass of TCPServer and set allow_reuse_address to True.
# This sets the SO_REUSEADDR flag on the underlying socket.
...
try:
    # Use our new ReusableTCPServer instead of the standard socketserver.TCPServer
